\begin{document}
\appendix{Supplementary Information: Deep reinforcement learning for the real time control of stormwater systems}
...
\For{all $\mathcal{N}$ tanks}{Compute the \textit{filling degree}; $f^i = \nicefrac{\text{depth}^i}{\text{Max depth}^i}$}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{RL-SI-RL-SI-figures/new_reward.eps}
