...
\input{01-SmarterStormwaterSys/Chapter-1.tex}
\input{02-ShapingStormwater/Chapter-2.tex}
\input{03-DeepRL/Chapter-3.tex}

\startappendices
\input{Appendices/RL-SI.tex}
%\input{Appendices/SI_LBcontrol.tex}
%\input{Appendices/SI_sewerWRRF.tex}
%\input{Appendices/additional_act}

\bibliographystyle{unsrtnat}
\startbibliography
\begin{singlespace} % Bibliography must be single spaced
\bibliography{01-SmarterStormwaterSys/Chapter-1.bib,02-ShapingStormwater/Chapter-2.bib,03-DeepRL/Chapter-3.bib}
% Use the BibTeX file ``References.bib''.
\end{singlespace}
